    ...
    return (
        ...
        <div className='pt-[7rem] md:pt-[5rem] justify-center px-4 max-w-[1240px] min-h-screen mx-auto p-2 md:grid-cols-5 gap-8 dark:text-gray-300'>
            <div className='mb-2 md:pb-5'>
                <h2 className='pb-1'>Github Finder</h2>
                <h3>React JS / Tailwind / Next.js</h3>
            </div>
            <div className='flex shadow-xl rounded-2xl object-cover justify-self-center'>

                <Image src={githubfinder} alt="screenshot of casa property" height={1200} width={1200} className='object-cover rounded-3xl' />
            </div>
            ...
            <div className=''>
                <div className='col-span-4'>
                    ...
                    <p>
                        The Github Finder application is a minimalistic dark themed search tool to display Github users and their information using Github API.
                    ...
                    <a
                        href='https://github-finder-3021w2xvk-vsibley.vercel.app/'
                        target='_blank'
                        rel='noreferrer'
                    >
                        ...
                        <div className='col-span-4 md:col-span-1 shadow-lg mb-[7rem] shadow-gray-400 dark:shadow-black  rounded-xl pt-4'>
                            <div className='p-2'>
                                ...
                                <div className='grid grid-cols-2 md:grid-cols-3 items-center'>
                                    ...
                                    <p className=' text-gray-800 dark:text-gray-300  text-gray-800 dark:text-gray-300py-2 flex items-center'>
