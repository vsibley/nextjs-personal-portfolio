...
import blog from '../public/assets/projects/techblog.png'
    ...
    return (
        ...
        <div className='pt-[7rem] md:pt-[5rem] justify-center px-4 max-w-[1240px] min-h-screen mx-auto p-2 md:grid-cols-5 gap-8'>
            <div className='mb-2 md:pb-5'>
                <h2 className='pb-1'>Personal Blog</h2>
                <h3>React JS / Tailwind / Next.js</h3>
            </div>
            <div className='flex shadow-xl rounded-2xl object-cover justify-self-center'>

                <Image src={blog} alt="screenshot of casa property" height={1200} width={1200} className='object-cover rounded-3xl' />
            </div>
            ...
            <div className=''>
                <div className='col-span-4'>
                    ...
                    <p>
                        This app was built using Next.js to increase SEO.
