        ...
        <p className='pb-8'>My skills are versed in technoogies enabeling me to take a product from conseption and turn it into a final product providing exceptional UX/UI and code architecture. </p>
            <div className='grid md:grid-cols-2 gap-8'>
              ...
              <p className='text-2xl font-bold tracking-wider py-4 uppercase'>Web 2 Skills 🌐 </p>
                              <p className='text-gray-600 tracking-wide'>HTML, CSS, JavaScript, Typescript, React, Next.js, Node.js, GraphQL, Tailwind CSS, Bootstrap, Git, Github, CI/CD skill, Sass/Scss, SEO, Figma.</p>
                    </div>
                </div>
              ...
              <p className='text-gray-600 tracking-wide '>Blockchain Basics, Solidity, Hardhat, Ganache, Ethers.js, SDK, Remix, Major DeFi Protocols. </p>
                    </div>
